...
void ofApp::setup(){
    ...
    color1.addListener(this, &ofApp::color1Changed );
    color2.addListener(this, &ofApp::color2Changed );
...
void ofApp::exit( )
{
    ...
    color1.removeListener(this, &ofApp::color1Changed );
    color2.removeListener(this, &ofApp::color2Changed );
}

void ofApp::color1Changed(ofColor & color)
{
    
}

void ofApp::color2Changed(ofColor & color)
{
